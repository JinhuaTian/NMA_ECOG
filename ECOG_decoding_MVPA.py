...
# load neural RDM
RDMPath = '/nfs/a2/userhome/tianjinhua/workingdir/nma/ECOGRDM2x100_subj1.npy'
...
plt.plot(range(-20,nTime-20),RDMcorrAdapt,label='Adapt Level',color='mediumblue')

# plot significant p value 
RDMpStim[(RDMpStim>0.01)] = None
RDMpStim[(RDMpStim<=0.01)] = -0.6
RDMpAdapt[(RDMpAdapt>0.01)] = None
RDMpAdapt[(RDMpAdapt<=0.01)] = -0.63
